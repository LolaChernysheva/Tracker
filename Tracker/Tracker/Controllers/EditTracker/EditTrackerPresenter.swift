...
final class EditTrackerPresenter {
    ...
    init(
        ...
        self.enteredEmogi = tracker.emogi
...
extension EditTrackerPresenter: EditTrackerPresenterProtocol {
    ...
    func save() {
        ...
        let tracker = Tracker(id: tracker.id, title: enteredActivityName, color: enteredColor ?? .orchid, emogi: enteredEmogi, schedule: enteredSchedule, category: enteredCategory, isPinned: tracker.isPinned)
